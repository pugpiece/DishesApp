...
{
    public partial class Inst_To_DishAdd : Form
    {
        public Inst_To_DishAdd()
        {
            InitializeComponent();
        }

        private void Inst_To_Dish_Load(object sender, EventArgs e)
        {
        ...
        private void AddButton_Click(object sender, EventArgs e)
        {
            ...
            string sInsSql = "Insert into Inst_To_Dish(ID_INSTRUMENT, ID_DISH) Values({0}, {1})";
